...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('task', default='mot_sche', help='mot_sche')
        ...
        # Flag for Scheduling (Track Initialization)
        self.parser.add_argument('--add_decision_head', action='store_true',
                                 help='Decision head.')
        self.parser.add_argument('--add_attention', action='store_true', help='apply long/short term attention')
        self.parser.add_argument('--decision_thres', type=float, default=0.5, help='decision thresh for scheduling')
        self.parser.add_argument('--decision_dim', type=int, default=64, help='feature dim for decision head')
        self.parser.add_argument('--buffer_size', type=int, default=4, help='Attention buffer_size')
        self.parser.add_argument('--freeze_detector', action='store_true', help='Detector parameter freezing')
        self.parser.add_argument('--seq', type=str, default='', help='sequence_selection')
        self.parser.add_argument('--public', action='store_true', help='Tracking using public detection')
        self.parser.add_argument('--preDet2input', action='store_true', help='previous detections is to input a tracking process.')
        self.parser.add_argument('--low_dets_conf', type=float, default=0.8, help='...')
        self.parser.add_argument('--term_score', type=float, default=0.5, help='...')

        # For MOT20 test
        self.parser.add_argument('--lambda_a', type=float, default=0.98, help='weight hyperparameter for app. mot. affinity')
        self.parser.add_argument('--lambda_b', type=float, default=0.75, help='weight hyperparameter for app+mot. shp. affinity')
        self.parser.add_argument('--h1_thr', type=float, default=0.4, help='h1 step hungarian thr')
        self.parser.add_argument('--h2_thr', type=float, default=0.5, help='h2 step hungarian thr')
        self.parser.add_argument('--h3_thr', type=float, default=0.3, help='h3 step hungarian thr')
    ...
    def init(self, args=''):
        default_dataset_info = {
            ...
            'mot_sche': {'default_resolution': [608, 1088], 'num_classes': 1,
                         'mean': [0.408, 0.447, 0.470], 'std': [0.289, 0.274, 0.278],
                         'dataset': 'jde', 'nID': 14455},
        }
